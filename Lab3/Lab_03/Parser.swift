...
//  Lab_03
//
//  Created by Serguei Diaz on 07.05.2024.
//
...
struct Rules {
    ...
    static func getRule(_ nonTerminal: NonTerminal) -> [[NodeType]] {
        ...
        case .block: //{<списокоператоров>}
            return [
                [.terminal(subType: .bracketOpen), .nonTerminal(subType: .operatorsList), .terminal(subType: .semicolon), .terminal(subType: .bracketClose)]
            ]
